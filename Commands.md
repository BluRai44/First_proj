...
__Примечание__: **ЧТО-ТО ИЗ 3ЕЙ ВЕТКИ** *--d в низком регистре помогает удалить ветку только в том случае, когда произведено ее слияние с another веткой предварительно
